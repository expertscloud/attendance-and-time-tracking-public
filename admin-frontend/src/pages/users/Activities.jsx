...
import { Box, Chip, IconButton, Stack, Tooltip as MuiTooltip, TextField, Typography, useTheme } from '@mui/material';
import { useQuery } from '@tanstack/react-query';
import { Bar, BarChart, BarStack, ResponsiveContainer, Tooltip, XAxis, YAxis } from 'recharts';
import dayjs from 'dayjs';
import { getActivityStatsByDate } from './UsersApiCalls';
...
const Activities = ({ userId }) => {
  ...
  const { data, isLoading, isRefetching, refetch } = useQuery({
    ...
    queryFn: () => getActivityStatsByDate(userId, date),
  ...
  return (
    <Box sx={{ p: { xs: 2, sm: 3 }, borderRadius: 2, bgcolor: 'background.paper', boxShadow: 1 }}>
      <Stack
